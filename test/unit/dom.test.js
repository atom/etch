...
describe('etch.dom', () => {
  ...
  it('can construct elements based on scalar observations', async () => {
    ...
    let vnodeObservation = observe(model, 'greeting', 'greeted', (greeting, greeted) =>
      <div>
        ...
        <span className='greeted'>{greeted}</span>
      </div>
    )
  ...
  it('allows scalar observations to be used as attributes', async () => {
    ...
    let newVnode = <div className={observe(newModel, 'class')}>Hello World</div>
  ...
  it('allows scalar observations to be used as children', async () => {
    ...
    let vnode = (<div>
      {observe(model, 'greeting', (greeting) => <span className='greeting'>{greeting}</span>)}
    ...
    let newVnode = (<div>
      {observe(newModel, 'greeting', (greeting) => <span className='greeting'>{greeting}</span>)}
      {observe(newModel, 'greeted', (greeted) => <span className='greeted'>{greeted}</span>)}
    </div>)
  ...
  it('allows scalar text observations to be used as children', async () => {
    ...
    let vnode = (<div>
      <span className='greeting'>{observe(model, 'greeting')}</span>
