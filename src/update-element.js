...
// given component in a given frame. This means you can call `updateElement`
...
// completed.
export function updateElement (component) {
...
// properties on the component, which are assigned in the `createElement`
// function.
//
...
// updated.
//
// If `updateElement` is called during the invocation of `updateElementSync`,
...
export function updateElementSync (component) {
